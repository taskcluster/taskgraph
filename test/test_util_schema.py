...
class SimpleTestSchema(Struct, rename=None, omit_defaults=False):
    x: int
    y: str
...
class TestCheckSchema(unittest.TestCase):
    def test_schema(self):
        ...
        class CamelCaseSchema(Struct, rename=None, omit_defaults=False):
            camelCase: int
    ...
    def test_extend_not_supported(self):
        ...
        class SimpleSchema(Struct, rename=None, omit_defaults=False):
            kebab_case: int
