...
class TaskContextChildStruct(Struct):
    """
...
class TaskContextStruct(Struct, forbid_unknown_fields=False):
    ...
    # Optional fields
    task_context: Optional[TaskContextChildStruct] = None
    name: Optional[str] = None


transforms = TransformSequence()
transforms.add_validate(TaskContextStruct)
