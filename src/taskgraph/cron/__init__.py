...
from taskgraph.util.vcs import calculate_head_rev
...
def taskgraph_cron(options):
    ...
    params = {
        ...
        'head_rev': calculate_head_rev(options['repository_type'], root),

        'repository_type': options['repository_type'],
    ...
    if 'head_ref' in options:
        params['head_ref'] = options['head_ref']
