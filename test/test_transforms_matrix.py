...
def assert_substitution_defer(tasks):
    assert tasks == [
        {
            "attributes": {"matrix": {"animal": "dog"}},
            ...
            "name": "task-dog",
            "task-context": {
                "from-object": {"matrix": {"animal": "dog"}},
                "substitution-fields": ["description", "name"],
            },
        }
    ]
...
@pytest.mark.parametrize(
    ...
    (
        ...
        pytest.param(
            {
                "description": "A {matrix[animal]} task!",
                "matrix": {"defer-substitution": True, "animal": ["dog"]},
            },
            id="substitution_defer",
        ),
        pytest.param(
            {
                "description": "A {matrix[animal]} task!",
