...
from taskgraph.util.schema import Struct, taskref_or_string_msgspec
...
@run_task_using(
    "docker-worker", "run-task", schema=RunTaskStruct, defaults=worker_defaults
)
...
@run_task_using(
    "generic-worker", "run-task", schema=RunTaskStruct, defaults=worker_defaults
)
