...
def dump(
    o: _MappingT, f: SupportsWrite[str], encoder: TomlEncoder[_MappingT] | None = ...
) -> str: ...
...
class TomlPreserveInlineDictEncoder(TomlEncoder[_MappingT]):
    ...
    @overload
    def __init__(
        self: TomlPreserveInlineDictEncoder[dict[str, Any]],
        _dict: type[dict[str, Any]] = ...,
    ) -> None: ...
...
class TomlArraySeparatorEncoder(TomlEncoder[_MappingT]):
    ...
    @overload
    def __init__(
        self, _dict: type[_MappingT], preserve: bool = ..., separator: str = ...
    ) -> None: ...
    @overload
    def __init__(
