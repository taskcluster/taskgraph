...
def test_find_task_id(monkeypatch):
    ...
    mock_index.findTask.return_value = None
...
def test_get_current_scopes(monkeypatch):
    ...
    monkeypatch.setattr(tc, "get_taskcluster_auth", lambda: mock_auth)
...
def test_purge_cache(monkeypatch):
    ...
    monkeypatch.setattr(tc, "get_taskcluster_purge_cache", lambda: mock_purge_cache)
...
def test_send_email(monkeypatch):
    ...
    monkeypatch.setattr(tc, "get_taskcluster_notify", lambda: mock_notify)
