...
class MatrixChildStruct(Struct, forbid_unknown_fields=False):
    """
...
class MatrixStruct(Struct, forbid_unknown_fields=False):
    """Schema for matrix transforms.
    ...
    name: str
    matrix: Optional[MatrixChildStruct] = None


transforms = TransformSequence()
transforms.add_validate(MatrixStruct)
