...
from coverage.collector import HAS_CTRACER, Collector
...
class Coverage(TConfigurable):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        self,
        data_file: str | DefaultValue | None = DEFAULT_DATAFILE,
    ...
    def sys_info(self) -> Iterable[tuple[str, Any]]:
        ...
        info = [
            ...
            (
                "data_file",
                self._data.data_filename() if hasattr(self, "_data") else "-none-",
            ),
