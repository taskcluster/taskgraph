...
class RunDescriptionSchema(Schema):
    ...
    attributes: TaskDescriptionSchema.__annotations__["attributes"] = msgspec.field(
        default_factory=dict
    )  # type: ignore
    task_from: TaskDescriptionSchema.__annotations__["task_from"] = None  # type: ignore
    dependencies: TaskDescriptionSchema.__annotations__["dependencies"] = msgspec.field(
        default_factory=dict
    )  # type: ignore
    soft_dependencies: TaskDescriptionSchema.__annotations__["soft_dependencies"] = (
        msgspec.field(default_factory=list)
    )  # type: ignore
    if_dependencies: TaskDescriptionSchema.__annotations__["if_dependencies"] = (
        msgspec.field(default_factory=list)
    )  # type: ignore
    requires: TaskDescriptionSchema.__annotations__["requires"] = "all-completed"  # type: ignore
    ...
    routes: TaskDescriptionSchema.__annotations__["routes"] = msgspec.field(
        default_factory=list
    )  # type: ignore
    scopes: TaskDescriptionSchema.__annotations__["scopes"] = msgspec.field(
        default_factory=list
    )  # type: ignore
    tags: TaskDescriptionSchema.__annotations__["tags"] = msgspec.field(
        default_factory=dict
    )  # type: ignore
    extra: TaskDescriptionSchema.__annotations__["extra"] = msgspec.field(
        default_factory=dict
    )  # type: ignore
    ...
    run_on_tasks_for: TaskDescriptionSchema.__annotations__["run_on_tasks_for"] = (
        msgspec.field(default_factory=list)
    )  # type: ignore
    run_on_git_branches: TaskDescriptionSchema.__annotations__[
        "run_on_git_branches"
    ] = msgspec.field(default_factory=list)  # type: ignore
    shipping_phase: TaskDescriptionSchema.__annotations__["shipping_phase"] = None  # type: ignore
    always_target: TaskDescriptionSchema.__annotations__["always_target"] = False  # type: ignore
    optimization: TaskDescriptionSchema.__annotations__["optimization"] = None  # type: ignore
    needs_sccache: TaskDescriptionSchema.__annotations__["needs_sccache"] = False  # type: ignore
