...
class DebugControl:
    ...
    def __init__(self, options: Iterable[str], output: IO[str] | None) -> None:
...
def short_stack(limit: int | None = None, skip: int = 0) -> str:
...
def dump_stack_frames(
    limit: int | None = None, out: TWritable | None = None, skip: int = 0
) -> None:
