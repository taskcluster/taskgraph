...
from taskgraph.transforms.task import TaskDescriptionStruct, TaskDescriptionWorkerStruct
...
class RunStruct(Struct, rename=None, forbid_unknown_fields=False):
...
class RunDescriptionStruct(Struct):
    """Schema for run transforms."""

    # Required fields first
    description: TaskDescriptionStruct.__annotations__["description"]  # type: ignore  # noqa: F821
    run: RunStruct
    worker_type: TaskDescriptionStruct.__annotations__["worker_type"]  # type: ignore  # noqa: F821
    ...
    priority: TaskDescriptionStruct.__annotations__["priority"] = None  # type: ignore[misc,assignment]
    attributes: TaskDescriptionStruct.__annotations__["attributes"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=dict
    )
    task_from: TaskDescriptionStruct.__annotations__["task_from"] = None  # type: ignore[misc,assignment]
    dependencies: TaskDescriptionStruct.__annotations__["dependencies"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=dict
    )
    soft_dependencies: TaskDescriptionStruct.__annotations__["soft_dependencies"] = (  # type: ignore[misc,assignment]
        msgspec.field(default_factory=list)
    )
    if_dependencies: TaskDescriptionStruct.__annotations__["if_dependencies"] = (  # type: ignore[misc,assignment]
        msgspec.field(default_factory=list)
    )
    requires: TaskDescriptionStruct.__annotations__["requires"] = "all-completed"  # type: ignore[misc,assignment]
    deadline_after: TaskDescriptionStruct.__annotations__["deadline_after"] = None  # type: ignore[misc,assignment]
    expires_after: TaskDescriptionStruct.__annotations__["expires_after"] = None  # type: ignore[misc,assignment]
    routes: TaskDescriptionStruct.__annotations__["routes"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=list
    )
    scopes: TaskDescriptionStruct.__annotations__["scopes"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=list
    )
    tags: TaskDescriptionStruct.__annotations__["tags"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=dict
    )
    extra: TaskDescriptionStruct.__annotations__["extra"] = msgspec.field(  # type: ignore[misc,assignment]
        default_factory=dict
    )
    treeherder: TaskDescriptionStruct.__annotations__["treeherder"] = None  # type: ignore[misc,assignment]
    index: TaskDescriptionStruct.__annotations__["index"] = None  # type: ignore[misc,assignment]
    run_on_projects: TaskDescriptionStruct.__annotations__["run_on_projects"] = None  # type: ignore[misc,assignment]
    run_on_tasks_for: TaskDescriptionStruct.__annotations__["run_on_tasks_for"] = (  # type: ignore[misc,assignment]
        msgspec.field(default_factory=list)
    )
    run_on_git_branches: TaskDescriptionStruct.__annotations__[  # type: ignore[misc,assignment]
        "run_on_git_branches"  # type: ignore[misc,assignment]
    ] = msgspec.field(default_factory=list)
    shipping_phase: TaskDescriptionStruct.__annotations__["shipping_phase"] = None  # type: ignore[misc,assignment]
    always_target: TaskDescriptionStruct.__annotations__["always_target"] = False  # type: ignore[misc,assignment]
    optimization: TaskDescriptionStruct.__annotations__["optimization"] = None  # type: ignore[misc,assignment]
    needs_sccache: TaskDescriptionStruct.__annotations__["needs_sccache"] = False  # type: ignore[misc,assignment]
    ...
    when: Optional[WhenStruct] = None
    # A list of artifacts to install from 'fetch' tasks.
    fetches: Dict[str, List[Union[str, FetchesStruct]]] = msgspec.field(
        default_factory=dict
    )
    # This object will be passed through to the task description, with additions
    # provided by the task's run-using function.
    worker: Optional[TaskDescriptionWorkerStruct] = None


transforms = TransformSequence()
transforms.add_validate(RunDescriptionStruct)
...
class AlwaysOptimizedRunStruct(Struct, omit_defaults=False):
    """Schema for always-optimized run tasks."""

    using: Literal["always-optimized"]


@run_task_using("always-optimized", "always-optimized", AlwaysOptimizedRunStruct)
